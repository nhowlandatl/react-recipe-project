...
//       return(
//         <MDBContainer>
//           <MDBModal show={this.state.show} onHide={this.handleClose}>
//               <MDBModalHeader closeButton>
//                   Welcome to the Pantry Assistant!
//               </MDBModalHeader>
//               <MDBModalBody>This app is designed to help you maximize the use of your pantry and spend less money eating out. You can input ingredients and find suitable recipes. You can also select whether recipes use any or all of the ingredients you've input.
//               </MDBModalBody>
//               <MDBModalFooter>
